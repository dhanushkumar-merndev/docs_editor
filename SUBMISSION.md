...
### Sync
Content sync uses lightweight Supabase Realtime Broadcast for live Markdown draft updates and a 5-second polling fallback for persisted changes. The collaborator marker is a blinking caret broadcast from click/focus activity, throttled to keep the channel lightweight.
